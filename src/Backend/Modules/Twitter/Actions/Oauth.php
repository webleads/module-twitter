...
class Oauth extends BackendBaseAction
{
    ...
    public function execute()
    {
        ...
        if ($this->id !== null && BackendTwitterModel::exists($this->id)) {
            ...
            if ($this->user['oauth_status'] == 'approved') {
            ...
            try {
                if ($oAuthToken == '' || $oAuthVerifier == '') {
                    ...
                    BackendTwitterHelper::getTwitterInstance()->oAuthRequestToken(SITE_URL . BackendModel::createURLForAction('Oauth',
                            null, null, array('id' => $this->id)));
                    ...
                    $response = BackendTwitterHelper::getTwitterInstance()->oAuthAccessToken($oAuthToken,
                        $oAuthVerifier);
                    ...
                    if (isset($response['oauth_token']) && isset($response['oauth_token_secret'])) {
                        ...
                        throw new BackendException('Access token not received');
                    }
                }
