...
class Settings extends BackendBaseActionEdit
{
    ...
    private function loadForm()
    {
        ...
        $this->frm->addText('consumer_secret',
            BackendModel::getModuleSetting($this->URL->getModule(), 'consumer_secret'));
    }
    ...
    protected function parse()
    {
        ...
        if ($consumerKey == '') {
            $this->tpl->assign('noConsumerKey', true);
        }
        if ($consumerSecret == '') {
            $this->tpl->assign('noConsumerSecret', true);
        }
        if ($consumerKey == '' || $consumerSecret == '') {
            $this->tpl->assign('noConsumerKeys', true);
        }
    }
    ...
    private function validateForm()
    {
        ...
        if ($this->frm->isSubmitted()) {
            ...
            if ($this->frm->isCorrect()) {
                ...
                BackendModel::setModuleSetting($this->URL->getModule(), 'consumer_secret',
                    $txtConsumerSecret->getValue());
